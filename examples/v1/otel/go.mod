module github.com/go-monolith/contrib/examples/v1/otel

go 1.25.0

require (
	github.com/go-monolith/contrib/v1/otel v0.0.0
...
replace github.com/go-monolith/contrib/v1/otel => ../../../v1/otel
